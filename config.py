...
def get_arguments():
    ...
    parser.add_argument("--feature_file",default="", help="output feature file")
    parser.add_argument("--label_file", default="", help="output file")
    parser.add_argument("--time_series_file", default="", help="input file")
    # model args
    parser.add_argument(
        "--pool",
        default=5,
